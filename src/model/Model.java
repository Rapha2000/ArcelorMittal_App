...
public class Model implements java.beans.PropertyChangeListener{
	...
	/**
	 * Constructeur de la classe Model qui permet de créer la simulation et orowan
	 *
    ...
    */
	 ...
	 *
	 * @return notreModèle l'instance unique de la classe Model.
	 */
	 ...
	 * Si la propriété modifiée est "nchangementDonnee", un événement de changement de propriété est déclenché 
	 * pour indiquer que de nouvelles données ont été calculées par le module Orowan.
	 * Si la propriété modifiée est "tempsOrowan", un événement de changement de propriété est 
	...
	public void propertyChange(PropertyChangeEvent evt) {
		...
		String nomPropriete = evt.getPropertyName();
